...
window.addEventListener('mousedown', (e) => {
    ...
    if (e.target.closest('#top-bar') || e.target.closest('#bottom-menu') || e.target.closest('#inspect-panel') || e.target.closest('#character-menu') || e.target.closest('#regen-btn') || e.target.closest('#architect-menu') || e.target.closest('#inspect-widget') || e.target.closest('#action-panel')) return;
...
function initCancelButtons() {
    ...
    if (!actionList || !actionPanel) {
        console.log('ERROR: action-list or action-panel not found!');
        return;
    }
    ...
    // Add listeners for both click and mousedown to cover all cases
